...
const AttractionSection = () => {
  return (
    <main className="p-5 mt-5 attraction-container">
      <div className="p-5 container">
        <div className="attraction-section d-flex justify-content-center align-items-center row">
          <div className="col-lg-6 p-4">
            ...
            <div className="text-center">
              <Link to="/">
                <button className="px-4 py-2 text-secondary  border-2 border border-secondary bookingbutton">
                  BOOK NOW
                </button>{" "}
              </Link>
            </div>
